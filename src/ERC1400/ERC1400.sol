...
contract ERC1400 is Ownable2Step, ERC1643, EIP712 {
	// --------------------------------------------------------------- CONSTANTS --------------------------------------------------------------- //
	/**
	 ...
	 */
	function isIssuable() public view virtual returns (/*override*/ bool) {
		return _isIssuable;
	}
	 ...
	 */
	function totalSupply() public view virtual returns (/*override*/ uint256) {
		return _totalSupply;
	}
	 ...
	 */
	function partitionsOf(address account /*override*/) public view virtual returns (bytes32[] memory) {
	 ...
	 */
	function isOperator(address operator, address account /*override*/) public view virtual returns (bool) {
	...
	* @notice Error messages:
	...
	function authorizeOperator(address operator) public virtual /*override*/ {
		...
		//! emit AuthorizedOperator(operator, msg.sender); -Inherit from IERC1400
	}
	...
	function authorizeOperatorByPartition(bytes32 partition, address operator) public virtual /*override*/ {
		...
		//!emit AuthorizedOperatorByPartition(partition, operator, msg.sender); -Inherit from IERC1400
	}
	...
	function revokeOperator(address operator) public virtual /*override*/ {
		...
		//!emit RevokedOperator(operator, msg.sender); -Inherit from IERC1400
	}
	...
	function revokeOperatorByPartition(bytes32 partition, address operator) public virtual /*override*/ {
		...
		//!emit RevokedOperatorByPartition(partition, operator, msg.sender); -Inherit from IERC1400
	}
	...
	function _transferByPartition(
		...
		//!emit TransferByPartition(partition, operator, from, to, amount, data, operatorData); - Inherit
