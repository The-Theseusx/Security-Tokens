    ...
    ERC1400DocumentTest
{
    ...
    function testUserPartitionsUpdateProperly() public {
        ...
        assertTrue(
            ERC1400MockToken.isUserPartition(SHARED_SPACES_PARTITION, bob), "bob should have shared spaces partition"
        );
        assertTrue(ERC1400MockToken.isUserPartition(newPartition1, bob), "bob should have newPartition1 partition");
        assertFalse(ERC1400MockToken.isUserPartition(newPartition2, bob), "bob should not have newPartition2 partition");
    }
}
