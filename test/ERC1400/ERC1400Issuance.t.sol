...
abstract contract ERC1400IssuanceTest is ERC1400BaseTest {
    ...
    function testShouldFailWhenIssuingNotByIssuer() public {
        vm.expectRevert(
            abi.encodeWithSelector(
                AccessControlUnauthorizedAccount.selector, address(this), ERC1400MockToken.ERC1400_ISSUER_ROLE()
            )
        );
    ...
    function testShouldIssueTokensToERC1400ReceiverImplementer() public {
        ...
        assertEq(ERC1400MockToken.totalSupply(), INITIAL_SUPPLY + 1000e18, "token total supply should be 100_001_00e18");
        assertEq(
    ...
    function testIssueTokensByIssuer() public {
        ...
        assertEq(ERC1400MockToken.totalSupply(), INITIAL_SUPPLY + 100e18, "token total supply should be 100_000_100e18");
        assertEq(
    ...
    function testIssueTokenByPartitionByIssuer() public {
        ...
        assertEq(ERC1400MockToken.totalSupply(), INITIAL_SUPPLY + 150e18, "token total supply should be 100_000_150e18");
        assertEq(
